var bacterial_data_map = L.map('bacterial_data_map').setView([37.3687987, 127.7148404], 8.4);
...
function open_in_frame(url) {
	$('#container2_map_iframe').attr('src', url);
}

function open_in_frame(url) {
	$('#container4_map_iframe').attr('src', url);
}
